...
public class BasicSpellDialog extends JDialog implements IInventoryDialog {
    ...
    public BasicSpellDialog(BasicPlayerInventory p_player_inventory) {
    ...
    public static void main(String[] args) {
        BasicSpellDialog dialog = new BasicSpellDialog(null);
        dialog.pack();
