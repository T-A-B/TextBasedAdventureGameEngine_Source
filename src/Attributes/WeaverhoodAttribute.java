...
public class WeaverhoodAttribute extends PlayerAttribute implements IAttribute {
   boolean m_isLevelable = true;
   String m_attribute_name = "Weaverhood";
    String m_attribute_description = "Helps with being Weaver.";
