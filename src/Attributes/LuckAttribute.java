...
public class LuckAttribute extends PlayerAttribute implements IAttribute {
    boolean m_isLevelable = true;
    String m_attribute_name = "Luck";
    String m_attribute_description = "Luck...";
    double m_attribute_level;
    double m_starting_level = 1;
