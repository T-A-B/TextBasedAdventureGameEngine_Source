...
public class Dennyhood extends PlayerAttribute implements IAttribute {
   boolean m_isLevelable = true;
   String m_attribute_name = "Dennyhood";
    String m_attribute_description = "Ballin' and a swaggin'";
